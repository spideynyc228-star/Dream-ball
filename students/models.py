...
class Profile(models.Model):
    ...
    photo_position_x=models.PositiveSmallIntegerField(default=50)
    photo_position_y=models.PositiveSmallIntegerField(default=50)
    photo_scale=models.PositiveSmallIntegerField(default=100)
